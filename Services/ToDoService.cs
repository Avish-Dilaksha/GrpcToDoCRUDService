...
namespace GrpcToDoCRUDService.Services;

public class ToDoService(ApplicationDbContext _dbContext) : ToDoIt.ToDoItBase
{
    ...
    public override async Task<GetAllResponse> GetAllToDo(GetAllToDoRequest request, ServerCallContext context)
    {
